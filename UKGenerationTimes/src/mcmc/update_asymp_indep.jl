...
Based on [update_asymp_fun_indep.m](https://github.com/will-s-hart/UK-generation-times/blob/main/Functions/MCMC/update_asymp_fun_indep.m) from the original MATLAB implementation.
"""
